<template>
        ...
        <div class="w-[300px] h-[150px] bg-white/70 mx-3 rounded-lg">
            <div class="h-[70%] text-sm flex flex-col">
                ...
                <div class=" basis-[85%] flex justify-center items-center font-medium">
...
export default {
    ...
    methods: {
        ...mapActions(['deleteConfirmer', 'showConfirmationBox', 'deleteSingleCourse', 'deleteSigleStudent']),
        closeConfirmation() {
...
.confirmation-enter-from, .confirmation-leave-to {
    opacity: 0;
    /* transform: scale(0); */

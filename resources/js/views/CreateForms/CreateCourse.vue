                ...
                <div class="pb-[50px]">
                    <div class="bg-white/40 shadow-2xl m-10 mx-12 p-3 sm:p-5 border-t-8 border-t-sky-500">
                        <header class="text-center">
                            ...
                            <p class="text-sm sm:text-base mb-4 mt-3">Enter details of the course or go <router-link :to="{name: 'AllCourseEntries'}" class="text-black underline">back</router-link></p>
                        </header>
                        <hr class="my-[20px]">
                        <transition name="form" appear>
                            <form enctype="multipart/form-data" class="bg-slate-100/75 px-3 py-2 border rounded shadow-lg hover:shadow-2xl hover:border-blue-300 transition duration-500 pb-6" @submit="onSubmit">
                                ...
                                <div class="sm:flex">
                                    ...
                                    <div class="mb-6 basis-1/2 sm:pl-3">
                                        <BaseInput v-model="formFieldsCourseData.marks" name="Course Marks (CSV)" type="text" objKey="marks" class="h-[45px]">
                                        </BaseInput>
                                    </div>
                                </div>
                                <div class="mb-6">

    ...
    <div>
        ...
        <div class="h-full md:grid md:grid-rows-[60px_minmax(60px,_1fr)]" :class="`xl:grid-cols-[${navWidth}px_minmax(${navWidth}px,_1fr)]`">
            ...
            <div class="shadow-md m-5 p-5 flex justify-center">
                <div class="bg-slate-100/60 mb-5 w-[90%] sm:w-[75%] xl:w-[60%] sm:mx-5 flex flex-col items-center pt-3 pb-0 rounded-md shadow-md border-2 border-transparent hover:shadow-2xl hover:border-cyan-600 hover:bg-white/60 transition duration-500 mx-auto">
                    <div class="bg-sky-500/20 mb-2 w-full flex items-center justify-between px-1">
                        ...
                        <router-link :to="{name: 'EditCourse', params:{course_id: $route.params.course_id}}">
                            <div class="basis-[7%] text-sm sm:text-base flex items-baseline">
                                <div class="mr-2 ">
                                    Edit
                                </div>
                                <div>
                    ...
                    <div class="my-1 px-2  w-full mt-4">
                        ...
                        <div class="bg-slate-400/75 rounded-sm w-full my-2 px-2 text-center min-h-[50px] flex items-center justify-center overflow-hidden">
                            <p class="">
...
export default {
    ...
    computed: {
        ...mapGetters(['singleCourse', 'loadingStatus', 'navWidth'])
    },
    methods: {
